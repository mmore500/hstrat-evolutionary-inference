\begin{figure}
  ...
  \caption{%
  \textbf{}
    Comparison of phylogeny reconstructions %produced by the agglomerative trie-based algorithm
    across different hereditary stratigraphy resolutions in the plain evolutionary regime.}
