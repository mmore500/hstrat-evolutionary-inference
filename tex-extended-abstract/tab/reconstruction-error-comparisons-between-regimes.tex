\providecommand{\thecaption}{
  ...
  Comparisons were performed independently within each sensitivity analysis condition and reconstruction fidelities.
...
\csvstyle{myTableStyle}{
  ...
  \label{tab:reconstruction-error-comparisons-between-regimes},
