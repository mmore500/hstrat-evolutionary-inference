...
breathe_projects = {"Matthew Andres Moreno": "./doxyoutput/xml"}
...
project = "hstrat Evolutionary Inference"
...
latex_documents = [
    (
        master_doc,
        "hstrat-evolutionary-inference.tex",
        "hstrat Evolutionary Inference Documentation",
