...
# -*- coding: utf-8 -*-
#
# hstrat-evolutionary-inference documentation build configuration file, created by
...
project = u'hstrat Evolutionary Inference'
...
htmlhelp_basename = 'hstrat-evolutionary-inferencedoc'
...
latex_documents = [
    (master_doc, 'hstrat-evolutionary-inference.tex',
     u'hstrat Evolutionary Inference Documentation',
...
man_pages = [
    (master_doc, 'hstrat-evolutionary-inference',
     u'hstrat Evolutionary Inference Documentation',
     [author], 1)
]
