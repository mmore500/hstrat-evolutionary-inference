...
SUBSAMPLING_FRACTIONS="1.0 0.01"
...
j2 --format=yaml -o "${SBATCH_SCRIPT_PATH}" "stage=2+what=reconstruct_trees/reconstruct_tree.slurm.sh.jinja" << J2_HEREDOC_EOF
batch: ${BATCH}
