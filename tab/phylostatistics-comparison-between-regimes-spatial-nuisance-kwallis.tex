\csvstyle{myTableStyle}{
  ...
  \caption{%
    Kruskal-Wallis one-way analysis of variance tests for nonequivalence of distributions for each phylometric among surveyed evolutionary regimes with spatial structure (i.e., island count 1,024).
