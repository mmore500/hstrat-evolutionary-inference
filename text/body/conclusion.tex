...
Comparing phylometrics of reference trees against corresponding reconstructions, we found most that most phylometric statistics were somewhat sensitive to reconstruction error.
...
%These findings contribute foundations for development of rigorous phylogenetic assays .
%In particular, the the potentially confounding impact of spatial structure and reconstruction error, which before had been poorly characterized, will be relevant to distributed digital evolution systems at scale.
...
% This new capability clears an important hurdle to applying this technique in practice.
