...
Genomes in the simple explicit-fitness model were a single floating-point value, with higher magnitude corresponding to higher fitness.
...
Within Avida, digital organisms' genomes comprise sequences of virtual CPU instructions.
...
To achieve the phylogenetic tracking necessary for our experiments, we used a fork of Avida originally developed for research on MODES \citep{dolson2019modes}, linked in supplemental material.
...
A key use case for phylometric analysis in digital evolution is statistical tests to detect differences in evolutionary dynamics between treatments.
For this reason, we investigated the sensitivity of chosen phylometrics to discern between surveyed evolutionary conditions.
