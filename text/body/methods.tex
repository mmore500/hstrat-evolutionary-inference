...
% @ELD: Maybe say time steps instead of updates so we don't have to explain what an update is?
% @MAM: agreed, we should probably report summary statistics for generations elapsed
